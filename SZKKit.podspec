#
#  Be sure to run `pod spec lint ZKKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "盛子康" => "1292999509@qq.com" }
  # Or just: spec.author    = "盛子康"
  # spec.authors            = { "盛子康" => "" }
  # spec.social_media_url   = "https://twitter.com/盛子康"
  ...
  spec.source       = { :git => "https://github.com/steveszk/ZKKit.git", :tag => "#{spec.version}" }
  ...
  spec.library   = "CommonCrypto/CommonHMAC.h"
